...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="navbar-header">
        ...
        <a class="navbar-brand " href="#" style="padding-left: 35px">
            <span class="glyphicon glyphicon-home navFont"><strong class=“systemTitle”> 广商淘-留言审查模块</strong></span>
        </a>
    </div>
    ...
    <div class="panel panel-info" style="min-height: 500px;">
        ...
        <div class="panel-body" style="padding-bottom: 0px">
            <form class="form-inline">
                ...
                <input type="button" class="btn btn-primary btn-ms"  value="test" onclick="getOrderList()"/>
            </form>
